...
void ExtractSoldierCreateFromFile(HWFILE, SOLDIERCREATE_STRUCT*, bool stracLinuxFormat, const IEncodingCorrector* fixer);
...
void ExtractSoldierCreateFromFileWithChecksumAndGuess(HWFILE, SOLDIERCREATE_STRUCT*, UINT16 *checksum, const IEncodingCorrector* fixer);
